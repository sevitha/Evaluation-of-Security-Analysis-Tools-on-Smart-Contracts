...
def run_smartbugs(file_path):
    ...
    command = f"{smartbugs_path} -t mythril -f {file_path} --processes 2 --mem-limit 8g --timeout 600"
    subprocess.run(command, shell=True)

def main():
    # directory = "smartbugs/dataset/access_control"
    # directory = "smartbugs/dataset/arithmetic"
    # directory = "smartbugs/dataset/bad_randomness"
    # directory = "smartbugs/dataset/denial_of_service"
    directory = "smartbugs/dataset/short_addresses"
    results_dir = "results"
